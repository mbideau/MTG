...
def display_html_header(tab_title = 'MTG Deck Builder Assistant | made by Michael Bideau',
    ...
    html += '    .optional-side { grid-area: opt-sidebar; background: white; display: none; }'+'\n'
    html += '    .content { grid-area: content; }'+'\n'
    html += '    .main-footer { grid-area: footer; background: white; }'+'\n'
    html += '    .side .container { max-height: 100%; overflow-y: auto; }'+'\n'
    ...
    html += '      .main-nav { max-width: 300px; }'+'\n'
    html += '      .side-nav { display: none; }'+'\n'
    html += '      .optional-side { display: none; }'+'\n'
    html += '      body > .wrapper {'+'\n'
    ...
    html += '      .main-head, .main-nav, .side, .optional-side {'+'\n'
    html += '        position: sticky; box-sizing: border-box; z-index: 1;'+'\n'
    html += '      }'+'\n'
    html += '      .main-head { top: 0; height: 130px; }'+'\n'
    html += '      .main-nav, .side, .optional-side { top: 150px; height: calc(100vh - 150px); }'+'\n'
    html += '    }'+'\n'
    html += ''+'\n'
    ...
    html += '    }'+'\n'
    html += ''+'\n'
    html += '    @media (min-width: 1450px) and (max-width: 1549px) {'+'\n'
    html += '      body > .wrapper {'+'\n'
    ...
    html += '    }'+'\n'
    html += ''+'\n'
    html += '    @media (min-width: 1550px) {'+'\n'
    html += '      .optional-side { display: block; }'+'\n'
    html += '      body > .wrapper {'+'\n'
    html += '        grid-template-columns: 1fr 4fr 1fr 1fr;'+'\n'
    html += '        grid-template-areas:'+'\n'
    html += '          "header header  header      header"'+'\n'
    html += '          "nav    content opt-sidebar sidebar"'+'\n'
    html += '          "nav    footer  opt-sidebar sidebar";'+'\n'
    html += '      }'+'\n'
    html += '    }'+'\n'
    html += ''+'\n'
    ...
    html += '      .side, .optional-side { background: black; }'+'\n'
    ...
    html += '      var featCountElements = null;'+'\n'
    html += '      if ("cardfeat" in checkboxElement.dataset) {'+'\n'
    html += '        let cardFeat = checkboxElement.dataset.cardfeat;'+'\n'
    html += '        featCountElements = document.querySelectorAll("."+cardFeat+"-count");'+'\n'
    html += '      };'+'\n'
    ...
    html += '      </div>'+'\n'
    html += '    </aside>'+'\n'
    html += '    <aside class="optional-side">'+'\n'
    html += '      <div class="container">'+'\n'
    html += '        <p>Dataviz <small>(soon)</small></p>'+'\n'
    html += '      </div>'+'\n'
    html += '    </aside>'+'\n'
...
def get_html_toc(cssclass = '', show_deck_info = False, print_title = True):
